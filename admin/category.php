...
include 'functions/fetch_category_list.php';
...
<script src="js/table-category.js"></script>
<script src="js/add-modal.js"></script>
<script src="js/edit-modal-category.js"></script>
<script src="js/delete-modal-category.js"></script>