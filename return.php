    ...
    <div class="wrapper">
        ...
        <div class="row-body">
                    ...
                    <div id="search-results" class="container-contents-body">
                        ...
                        try {
                            ...
                            $sql = "
                                        ...
                                        WHERE 
                                            br.user_id = ? AND br.return_date IS NOT NULL AND br.return_date <> ''
                                        GROUP BY 
                                            b.book_id, br.return_date
                                        ORDER BY 
                                            br.return_date DESC
                                    ";
                            ...
                            // Group results by return_date
                            $groupedResults = [];
                            foreach ($result as $row) {
                                $groupedResults[$row['return_date']][] = $row;
                            }
            ...
            <div class="row-books-contents" id="book-details" style="display: none;">
                ...
                <div class="books-contents-id">ID</div>
